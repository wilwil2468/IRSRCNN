...
Adapted for Brevitas quantized models
"""
import torch
...
try:
    from utils.common import (
        read_image, write_image, rgb2ycbcr, ycbcr2rgb,
        gaussian_blur, upscale, norm01, denorm01
    )
    USE_COMMON = True
except ImportError:
    USE_COMMON = False
...
# Preprocessing parameters (same as test_ir.py)
